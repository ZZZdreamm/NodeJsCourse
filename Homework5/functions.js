...
function compareArrayFuncPerformances(
  array,
  functionName,
  func1,
  func2,
  ...
  console.log(
    `Average time for built-in ${functionName} function:`,
    totalTimeForFunc1,
    "milliseconds"
  );
  console.log(
    `Average time for custom ${functionName} function:`,
    totalTimeForFunc2,
    "milliseconds"
  );
  console.log(
    `${
      func1Better ? "Built-in" : "Custom"
    } ${functionName} function is faster by ${
      func1Better
        ? totalTimeForFunc2 - totalTimeForFunc1
        : totalTimeForFunc1 - totalTimeForFunc2
    } milliseconds\n`
  );
}

const testArray = Array.from({ length: 1000000 }, () =>
...
const builtInIntersectionTime = measureArrayPerformance(
  array1.filter.bind(array1),
...
const getArrayUnionTime = measureArrayPerformance(
  getArrayUnion,
  array1,
  array2
);
